...
const HeroSection = () => {
  return (
    <div id="Hero" class="relative min-h-screen bg-gray-900 md:p-20 p-10 overflow-hidden">
      ...
      <header className="relative mb-16 group">
        ...
        <div className=" mt-2 md:mt-10 text-xl font-semibold md:text-3xl text-yellow-400">Welcome to my portfolio page!</div>
        
        {/* fucntion button */}
        <div class="relative flex">
          <a href="#About" class="mt-10 px-4 text-sm md:px-6 py-2 md:font-bold text-gray-800 font-semibold rounded-xl transition-all duration-500 bg-gradient-to-tl from-red-600 via-yellow-500 to-yellow-400 bg-size-200 bg-pos-0 hover:bg-pos-100"> 
            About Me
          </a>
        </div>
        ...
        <div class="relative flex">
          <div class="flex mt-8 md:hidden">
            <a href="https://github.com/haoranli17365" class="p-2 hover:scale-150"><img class="h-5" src="github.png" alt=""/></a>
            <a href="https://www.linkedin.com/in/haoran-li-01ab8a174/" class="p-2 hover:scale-150"><img class="h-5" src="linkedin-icon.svg" alt=""/></a>
          </div>
        </div>
      </header>
