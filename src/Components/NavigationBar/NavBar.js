...
function NavBar() {
  ...
  return (
    <nav class="sticky top-0 z-50 bg-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6"> {/* define navigation bar size */}
        <div class="flex justify-between">
          ...
          <div class="flex space-x-4 text-gray-300"> {/* navbar left side: Logo and nav group */}
            <div class="pr-3">
              <a href="#" class="flex items-center py-3 px-3 text-yellow-400">
                ...
                <span class="font-bold">Haoran Li's Portfolio</span>
              </a>
            </div>
          ...
          <div class="hidden md:flex items-center space-x-1">
            <a href="#Contact" class="px-4 py-1 text-gray-800 font-semibold rounded-xl transition-all duration-500 bg-gradient-to-tl from-red-600 via-yellow-500 to-yellow-400 bg-size-200 bg-pos-0 hover:bg-pos-100">
              Hire Me
            </a>
          </div>
      ...
      {/* mobile menu items */}
      { menu && (
        <div class="mobile-menu md:hidden z-1">
        <a href="#" class="block py-2 px-4 text-gray-300 text-sm hover:bg-yellow-400 hover:text-gray-800">Home</a>
        <a href="#" class="block py-2 px-4 text-gray-300 text-sm hover:bg-yellow-400 hover:text-gray-800" >About Me</a>
        <a href="#" class="block py-2 px-4 text-gray-300 text-sm hover:bg-yellow-400 hover:text-gray-800">Skills & Projects</a>
        <a href="#" class="block py-2 px-4 text-gray-300 text-sm hover:bg-yellow-400 hover:text-gray-800">Contact</a>
        </div>
      )}
